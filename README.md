...
El laboratorio utiliza **Wazuh** como plataforma SIEM/XDR, **OPNsense** como firewall perimetral, **Windows Server 2022** con Active Directory, **Windows 10** como estación de trabajo y **Kali Linux** para realizar pruebas de seguridad controladas.
...
| Firewall        | OPNsense            | Firewall y seguridad perimetral |
